...
{return["#003f5c","#2f4b7c","#665191","#a05195","#d45087","#f95d6a","#ff7c43","ffa600","#003f5c","#2f4b7c","#665191","#a05195","#d45087","#f95d6a","#ff7c43","ffa600"]}
...
function populateChart(e){let a=duration(e),
  ...
  ,d=document.querySelector("#canvas2").getContext("2d"),
   ...
   new Chart(s,{type:"line",data:{labels:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],
   ...
   new Chart(d,{type:"bar",data:{labels:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],
   
   datasets:[{label:"Pounds",data:t,backgroundColor:["rgba(255, 99, 132, 0.2)","rgba(54, 162, 235, 0.2)","rgba(255, 206, 86, 0.2)","rgba(75, 192, 192, 0.2)","rgba(153, 102, 255, 0.2)","rgba(255, 159, 64, 0.2)"],
   borderColor:["rgba(255, 99, 132, 1)","rgba(54, 162, 235, 1)","rgba(255, 206, 86, 1)","rgba(75, 192, 192, 1)","rgba(153, 102, 255, 1)","rgba(255, 159, 64, 1)"],
   borderWidth:1}]},options:{title:{display:!0,text:"Pounds Lifted"},
   scales:{yAxes:[{ticks:{beginAtZero:!0}}]}}}),
   
   new Chart(n,{type:"pie",data:{labels:r,datasets:
    [{label:"Excercises Performed",backgroundColor:o,data:a}]},options:{title:{display:!0,text:"Excercises Performed"}}}),
